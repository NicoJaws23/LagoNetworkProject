...
write_csv(df_filtered, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\GroupCFilt.csv")
...
# Load dataset
df <- read.csv("C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\GroupCFilt.csv", stringsAsFactors = FALSE)
...
write.csv(adj_matrix_df, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\GroupC_sri_adjacency_matrix.csv")
...
write.csv(centrality_df, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\GroupC_centrality.csv")
plot(g)
