...
write.csv(centrality_results, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\Exports\\groupC_allTimeCent.csv")
...
d1centrality_results <- d1centrality_results %>%
  left_join(d, by = join_by("Individual" == "ID"))
write.csv(d1centrality_results, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\Exports\\groupC_p1Cent.csv")
...
d2centrality_results <- d2centrality_results %>%
  left_join(d, by = join_by("Individual" == "ID"))
write.csv(d2centrality_results, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\Exports\\groupC_p2Cent.csv")
...
d3centrality_results <- d3centrality_results %>%
  left_join(d, by = join_by("Individual" == "ID"))
write.csv(d3centrality_results, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\Exports\\groupC_p3Cent.csv")
...
d4centrality_results <- d4centrality_results %>%
  left_join(d, by = join_by("Individual" == "ID"))
write.csv(d4centrality_results, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\Exports\\groupC_p4Cent.csv")
