...
write_csv(df_filtered, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\GroupPFilt.csv")
...
# Load dataset
df <- read.csv("C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\GroupPFilt.csv", stringsAsFactors = FALSE)
...
write.csv(adj_matrix_df, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\GroupP_sri_adjacency_matrix.csv")
...
indivJoin <- right_join(d, individual_counts, by = c("ID" = "Subgroup"))
...
write.csv(centrality_df, "C:\\Users\\Jawor\\Desktop\\ANT392J\\LagoNetworkProject\\GroupP_centrality.csv")
plot(g)
